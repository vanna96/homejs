...
export default function Home() {
  ...
  const newComming = [
    ...
    },
    {
      ...
      imgurl:
        "https://www.halfbakedharvest.com/wp-content/uploads/2022/08/Caramelized-Shallot-and-Bacon-Goat-Cheese-Pizza-1.jpg",
      price: "$13.60",
    },
  ];
  ...
  const bestSelling = [
    {
      ...
      imgUrl:
        "https://images.deliveryhero.io/image/foodpanda/recipes/egg-fried-rice-recipe-1.jpg",
      price: "$6.00",
    },
    {
      id: 11,
    ...
    },
    {
      ...
      name: "Pizza royale",
      imgUrl:
        "https://img.cuisineaz.com/1024x768/2013/12/20/i95731-pizza-royale.jpg",
      price: "$12.00",
    },
  ];
